...
const Page = () => {
  ...
  const lastPrestation = data?.events.sort((a, b) => new Date(b.date) > new Date(a.date))[0];
  // const byDateDesc = data?.focus.sort((evtA, evtB) => (new Date(evtA.date) > new Date(evtB.date) ? -1 : 1)) || [];
  console.log(lastPrestation);
        ...
        <section className="ServicesContainer">
          ...
          <div className="ListContainer">
            ...
            <ServiceCard imageSrc="/images/hall-expo.png">
              <h3>Conférences</h3>
              724 events vous propose d’organiser votre évènement, quelle que soit sa taille, en s’adaptant à votre demande et à vos demandes. En
              tant que spécialistes de l’évènementiel, nous saurons trouver le lieu parfait ainsi que des solutions inédites pour capter votre
